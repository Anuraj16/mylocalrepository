	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<header class="header-area clearfix">
			...
			<nav class="amado-nav">
				<ul>
					...
					<li><a href="#" data-toggle="modal" data-target="#myModal"
						onClick="$('#loginModalId').show(); $('#signupModalId').hide()">Login/Signup</a>
					...
					<li><a
						href="${pageContext.request.contextPath}/productDetails">Product</a></li>
			...
			<div class="cart-fav-search mb-100">
				<a href="${pageContext.request.contextPath}/cart" class="cart-nav"><img
			...
			<div class="amado-pro-catagory clearfix">
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/1.jpg" alt=""> <!-- Hover Content -->
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/2.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $180</p>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/3.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $180</p>
							<h4>Modern Chair</h4>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/4.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $180</p>
							<h4>Night Stand</h4>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/5.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $18</p>
							<h4>Plant Pot</h4>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/6.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $320</p>
							<h4>Small Table</h4>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/7.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $318</p>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/8.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $318</p>
				...
				<div class="single-products-catagory clearfix">
					<a href="${pageContext.request.contextPath}/shop"> <img
						src="img/bg-img/9.jpg" alt=""> <!-- Hover Content -->
						<div class="hover-content">
							<div class="line"></div>
							<p>From $318</p>
							<h4>Home Deco</h4>
							...
							<nav class="navbar navbar-expand-lg justify-content-end">
								...
								<div class="collapse navbar-collapse" id="footerNavContent">
									<ul class="navbar-nav ml-auto">
										...
										<li class="nav-item"><a class="nav-link"
											href="${pageContext.request.contextPath}/productDetails">Product</a>
										</li>
										<li class="nav-item"><a class="nav-link"
			...
			<div class="modal-dialog">
				...
				<div class="modal-content" id="loginModalId">
					...
					<div class="modal-footer">
						...
						<p>
							Not a member? <a href="#"
								onClick="$('#loginModalId').hide(); $('#signupModalId').show()">
								Sign Up Here </a>
						</p>
						<p>
              ...
              <label><input type="checkbox" value="" checked>Remember me</label>
							...
							<div class="form-group">
								...
								<form:label path="firstName">
									<span class="glyphicon glyphicon-eye-open"></span> First Name</form:label>
								<!--  <input type="text" class="form-control" name="password" placeholder="Enter password"> -->
							...
							<div class="form-group">
								...
								<form:label path="lastName">
									<span class="glyphicon glyphicon-eye-open"></span> Last Name</form:label>
								<!--  <input type="text" class="form-control" name="password" placeholder="Enter password"> -->
							...
							<div class="form-group">
								...
								<form:label path="emailId">
									<span class="glyphicon glyphicon-eye-open"></span> Email</form:label>
								<!--  <input type="text" class="form-control" name="password" placeholder="Enter password"> -->
							...
							<div class="form-group">
								...
								<form:label path="phone">
									<span class="glyphicon glyphicon-eye-open"></span> Phone</form:label>
								<!--  <input type="text" class="form-control" name="password" placeholder="Enter password"> -->
							...
							<form:button id="register" name="register"
								...
								<span class="glyphicon glyphicon-off"></span>Register</form:button>
						</form:form>
						<%-- </form> --%>
					</div>
					<div class="modal-footer">
